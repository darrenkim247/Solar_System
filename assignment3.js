...
export class Assignment3 extends Scene {
    constructor() {
        ...
        this.shapes = {
            ...
            planet_3_ring: new defs.Torus(30, 30),
            planet_4: new defs.Subdivision_Sphere(4),
            planet_4_moon: new (defs.Subdivision_Sphere.prototype.make_flat_shaded_version())(1),
        };
        ...
        this.materials = {
            ...
            ring: new Material(new Ring_Shader(),
                {ambient: 1, color: hex_color("#B08040")}), //Added this for Planet 3 ring
            ...
            planet_1: new Material(new defs.Phong_Shader(),
                {ambient: 0, diffusivity: 1, color: hex_color("#ffffff"), specularity: 0}),
            planet_2_gouraud: new Material(new Gouraud_Shader(),
                {diffusivity: 0.1, color: hex_color("#80FFFF"), specularity: 1}),
            ...
            {ambient: 0, color: hex_color("#C7E4EE"), specularity: 1}),
            planet_4_moon: new Material(new defs.Phong_Shader(),
            {ambient: 0, color: hex_color("#ffffff"), specularity: 1}),
    ...
    display(context, program_state) {
        ...
        planet_2_transform = planet_2_transform.times(Mat4.rotation(t*.75, 0, 1, 0)).times(Mat4.translation(8, 0, 0));
        planet_3_transform = planet_3_transform.times(Mat4.rotation(t*.5, 0, 1, 0)).times(Mat4.translation(11, 0, 0)).times(Mat4.rotation(Math.sin(t), 1, 0, 0));
        let ring_transform = planet_3_transform.times(Mat4.rotation(1, 0, 1, 0)).times(Mat4.scale(4, 4, 0.1)); 
        planet_4_transform = planet_4_transform.times(Mat4.rotation(t*.25, 0, 1, 0)).times(Mat4.translation(14, 0, 0));

        //Moon
        let moon_transform = planet_4_transform;
        moon_transform = moon_transform.times(Mat4.rotation(t, 0, 1, 0)).times(Mat4.translation(2, 0, 0)).times(Mat4.scale(.25, .25, .25));
        ...
        this.shapes.planet_3_ring.draw(context, program_state, ring_transform, this.materials.ring);
        this.shapes.planet_4.draw(context, program_state, planet_4_transform, this.materials.planet_4);
        this.shapes.planet_4_moon.draw(context, program_state, moon_transform, this.materials.planet_4_moon.override({color: yellow}));
        ...
        if (this.attached != undefined) {
            // Blend desired camera position with cam matrix to pull camera to planet
    ...
    vertex_glsl_code() {
        ...
        return this.shared_glsl_code() + `
            ...
            void main(){                                                                   
                ...
                vertexcolor.xyz += phong_model_lights(N, vertex_worldspace);
            } `;
    }
...
class Ring_Shader extends Shader {
    ...
    fragment_glsl_code() {
        ...
        void main(){
            ...
            gl_FragColor = vec4( vec3(1,1,0), cos(length(distance)*20.0));
        }`;
    }
}
